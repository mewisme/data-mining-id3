...
- Quy ước nhãn đang dùng trong project/dataset:
  - `1` = **legitimate**
  - `0` = **phishing**
...
- UI song ngữ (English/Tiếng Việt), mặc định là **Tiếng Việt**.
...
- Trực quan cây quyết định bằng **Graphviz** (section cây tổng quan + tab cây trong section dự đoán).
